package dev.leonkim.springexception.advice;

import dev.leonkim.springexception.exception.UserException;
import dev.leonkim.springexception.exhandler.ErrorResult;
...
@Slf4j
@RestControllerAdvice(basePackages = "dev.leonkim.springexception.api")
